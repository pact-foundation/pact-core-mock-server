...
pub(crate) fn setup_app<'a>(program: &'a str, version: &'a str) -> App<'a> {
  App::new(program)
    ...
    .arg(Arg::with_name("compact-log")
      .long("compact-log")
      .conflicts_with_all(&["full-log", "pretty-log"])
      .takes_value(false)
      .help("Emit logs optimized for short line lengths."))
    .arg(Arg::with_name("log-no-span")
      .long("log-no-span")
      .takes_value(false)
      .help("Do not emit span context values for log events."))
